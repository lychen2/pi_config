...
python $HOME/.pi/agent/skills/docx/scripts/insert_note.py in.docx --kind footnote --text "hello" --marker "[[FN]]" --out out.docx

# Insert an endnote
python $HOME/.pi/agent/skills/docx/scripts/insert_note.py in.docx --kind endnote --text "source" --marker "[[EN]]" --out out.docx
