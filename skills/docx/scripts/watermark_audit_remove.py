...
Usage
-----
python $HOME/.pi/agent/skills/docx/scripts/watermark_audit_remove.py in.docx --mode report
python $HOME/.pi/agent/skills/docx/scripts/watermark_audit_remove.py in.docx --mode remove --contains DRAFT --out out.docx
"""
