...
python $HOME/.pi/agent/skills/docx/scripts/a11y_audit.py input.docx --fix_image_alt from_filename --out fixed.docx
python $HOME/.pi/agent/skills/docx/scripts/a11y_audit.py input.docx --fix_table_headers first_row --out fixed.docx
"""
