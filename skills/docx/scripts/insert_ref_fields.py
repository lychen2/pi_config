...
1) Add captions + bookmarks:
   python $HOME/.pi/agent/skills/docx/scripts/captions_and_crossrefs.py in.docx out_caps.docx --tables --bookmarks
2) Replace markers with REF fields:
   python $HOME/.pi/agent/skills/docx/scripts/insert_ref_fields.py out_caps.docx out_refs.docx
3) Materialize:
   python $HOME/.pi/agent/skills/docx/scripts/fields_materialize.py out_refs.docx --out out_refs_mat.docx
"""
