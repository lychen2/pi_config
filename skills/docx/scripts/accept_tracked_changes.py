...
Usage
-----
python $HOME/.pi/agent/skills/docx/scripts/accept_tracked_changes.py in.docx --mode report
python $HOME/.pi/agent/skills/docx/scripts/accept_tracked_changes.py in.docx --mode accept --out out.docx
python $HOME/.pi/agent/skills/docx/scripts/accept_tracked_changes.py in.docx --mode reject --out out.docx
"""
