...
Usage
-----
python $HOME/.pi/agent/skills/docx/scripts/internal_nav.py in.docx --out out.docx
python $HOME/.pi/agent/skills/docx/scripts/internal_nav.py in.docx --out out.docx --levels 1 2
python $HOME/.pi/agent/skills/docx/scripts/internal_nav.py in.docx --out out.docx --no_quicklinks
