...
Usage
-----
python $HOME/.pi/agent/skills/docx/scripts/fields_materialize.py in.docx --out out.docx
python $HOME/.pi/agent/skills/docx/scripts/fields_materialize.py in.docx --out out.docx --only SEQ
python $HOME/.pi/agent/skills/docx/scripts/fields_materialize.py in.docx --out out.docx --only SEQ REF
"""
