...
Historically this script used positional args:
  ...
  python $HOME/.pi/agent/skills/docx/scripts/style_normalize.py in.docx out.docx
...
the original signature but also supports `--out` as an alias:
  ...
  python $HOME/.pi/agent/skills/docx/scripts/style_normalize.py in.docx --out out.docx
"""
