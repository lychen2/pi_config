...
Usage
-----
python $HOME/.pi/agent/skills/docx/scripts/set_protection.py in.docx --mode readOnly --out out.docx
python $HOME/.pi/agent/skills/docx/scripts/set_protection.py in.docx --mode off --out out.docx
"""
