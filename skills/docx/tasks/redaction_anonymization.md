...
This bundle provides `$HOME/.pi/agent/skills/docx/scripts/redact_docx.py`, which redacts by editing OOXML text nodes while attempting to preserve layout:
...
```bash
python $HOME/.pi/agent/skills/docx/scripts/redact_docx.py ./input.docx \
