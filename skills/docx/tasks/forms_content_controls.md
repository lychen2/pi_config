...
- `$HOME/.pi/agent/skills/docx/scripts/content_controls.py`
...
```bash
python $HOME/.pi/agent/skills/docx/scripts/content_controls.py ./template.docx wrap_placeholders \
  --output ./template_sdt.docx
```

3. **Populate SDTs by tag**
```bash
python $HOME/.pi/agent/skills/docx/scripts/content_controls.py ./template_sdt.docx fill \
...
4. **Render for QA**
```bash
python $HOME/.pi/agent/skills/docx/render_docx.py ./filled.docx --output_dir ./out_forms
```
...
```bash
python $HOME/.pi/agent/skills/docx/scripts/content_controls.py ./template_sdt.docx list --json
```
