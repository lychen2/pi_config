...
```bash
python $HOME/.pi/agent/skills/docx/scripts/a11y_audit.py input.docx --fix_table_headers first_row --out a11y_fixed.docx
```
...
```bash
python $HOME/.pi/agent/skills/docx/render_docx.py a11y_fixed.docx --output_dir out_a11y
```
