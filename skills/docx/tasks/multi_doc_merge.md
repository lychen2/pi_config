...
```bash
python $HOME/.pi/agent/skills/docx/scripts/merge_docx_append.py base.docx append.docx --out merged.docx
```
...
```bash
python $HOME/.pi/agent/skills/docx/scripts/merge_docx_append.py base.docx append.docx --out merged.docx --allow_drawings
```

## Verify
Always render and inspect:
```bash
python $HOME/.pi/agent/skills/docx/render_docx.py merged.docx --output_dir out_merged
```
