...
## Scrub a doc
```bash
python $HOME/.pi/agent/skills/docx/scripts/privacy_scrub.py input.docx --out scrubbed.docx
```

## Verify
```bash
python $HOME/.pi/agent/skills/docx/render_docx.py scrubbed.docx --output_dir out_scrubbed
```
