...
```bash
python $HOME/.pi/agent/skills/docx/scripts/xlsx_to_docx_table.py ./input.xlsx ./table.docx --title "Table: Results"
```
...
```bash
python $HOME/.pi/agent/skills/docx/scripts/docx_table_to_csv.py ./input.docx --table_index 0 --out ./table0.csv
```
