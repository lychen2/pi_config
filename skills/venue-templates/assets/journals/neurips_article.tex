...
% Retain concrete method and evaluation boundaries; avoid boilerplate disclaimers.
\subsection{Limitations}
State model or experiment conditions that bound interpretation and the consequence. For example, results on one hardware family do not establish performance on other accelerators.
