...
% Keep limitations that affect interpretation or that the venue requires;
% state each as a concrete condition with its consequence, not as a generic disclaimer.
\subsection*{Limitations and future directions}
Explain any material boundary on interpretation and its consequence. For example, a 48-hour observation window does not establish whether the phenotype persists later.
