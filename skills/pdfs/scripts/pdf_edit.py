...
Golden rule: after ANY edit, render and visually verify:
  python render_pdf.py out.pdf --out_dir ./_renders/out
...
Examples:
  ...
  python pdf_edit.py split input.pdf --out_dir ./split
  python pdf_edit.py select input.pdf --pages 1-2,5 -o excerpt.pdf
  python pdf_edit.py extract input.pdf --ranges 1-3,7,10-12 --out_dir ./extract
