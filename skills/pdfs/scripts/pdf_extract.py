...
Examples:
  python pdf_extract.py text input.pdf --method pdfplumber --out ./text.txt
  python pdf_extract.py words input.pdf --out words.csv
  python pdf_extract.py tables input.pdf --out_dir ./tables --format xlsx
  python pdf_extract.py images input.pdf --out_dir ./images
