...
Usage:
  python redact_smoketest.py  # writes to ./_pdf_redact_smoke
  python redact_smoketest.py --workdir ./_pdf_redact_smoke_custom
"""
...
def main() -> int:
    ...
    ap.add_argument("--workdir", default="./_pdf_redact_smoke")
