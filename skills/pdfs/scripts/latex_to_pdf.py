...
Examples:
  python latex_to_pdf.py main.tex --out_dir ./out
  python latex_to_pdf.py main.tex --out_dir ./out --engine xelatex
  python latex_to_pdf.py main.tex -o ./out.pdf --engine xelatex
