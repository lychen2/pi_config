...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/render_pdf.py input.pdf --engine pdfium
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/ocr_pdf.py input.pdf -o out.pdf --force
```
