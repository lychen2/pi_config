...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/render_pdf.py report.pdf --out_dir ./_renders/report
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/latex_to_pdf.py input.tex -o output.pdf
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/md_to_pdf.py input.md -o output.pdf
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/html_to_pdf.py input.html -o output.pdf
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/lo_convert_to_pdf.py input.docx --out_dir ./_tmp
```
...
- `$HOME/.pi/agent/skills/docs` for DOCX
- `$HOME/.pi/agent/skills/slides` for PPTX
...
Finally, delete intermediate artifacts under `./_tmp` and `./_renders`.
