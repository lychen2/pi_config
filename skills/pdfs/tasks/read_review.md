...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/render_pdf.py input.pdf --out_dir ./_renders/input
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/render_pdf.py input.pdf --out_dir ./_renders/input --pages 1-5
```

### 2) Get a quick structural overview

```bash
python $HOME/.pi/agent/skills/pdfs/scripts/pdf_inspect.py input.pdf
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/pdf_extract.py text input.pdf --method pdfplumber --pages 3-4 --out ./_tmp/extracted.txt
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/ocr_pdf.py input.pdf -o ./_tmp/input_ocr.pdf
```
