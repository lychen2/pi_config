...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/render_pdf.py input.pdf --out_dir ./_renders/in --pages 1 --dpi 200
open ./_renders/in/page-1.png
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/box_picker_html.py input.pdf --page 1 --dpi 200 --out ./box_picker.html
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/place_text_by_boxes.py input.pdf spec.json values.json \
  --out ./_tmp/stamped.pdf \
  --preview_pdf ./_tmp/preview.pdf

python $HOME/.pi/agent/skills/pdfs/scripts/render_pdf.py ./_tmp/preview.pdf --out_dir ./_renders/preview --pages 1
open ./_renders/preview/page-1.png
```
...
```bash
python $HOME/.pi/agent/skills/pdfs/scripts/render_pdf.py ./_tmp/stamped.pdf --out_dir ./_renders/out --pages 1
