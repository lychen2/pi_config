...
name: nature-figure
description: >-
  Creates, revises, audits, and polishes submission-grade scientific figures for Nature and other high-impact journals using Python, R, or an explicit OpenRouter AI-schematic route. Use for manuscript figures, multi-panel plots, journal-ready SVG/PDF/TIFF exports, graphical abstracts, mechanism diagrams, scientific data visualization, and Chinese requests such as 论文配图、科研绘图、作图、出图、论文图表、机制示意图、图形摘要. Defines the figure conclusion, evidence logic, export contract, and review risks before drawing; remembers the user's Python/R preference. Not for dashboards or Illustrator/Figma-first infographics.
version: 2.0.0
