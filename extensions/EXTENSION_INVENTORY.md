...
| `pi-science-workbench` | Opt-in scientific execution package: persistent local Python kernel, managed local/SSH jobs, run provenance, artifact integrity, and explicit scientific validators; not installed by the default installer | `pi-science-workbench/index.ts`, `pi-science-workbench/src/`, `pi-science-workbench/python/science_workbench/` |
