...
export const configPath = join(getAgentDir(), "matugen-footer.json");
...
export const defaultConfig: PolishedTuiConfig = {
	...
	colors: {
		cwd: "muted",
		gitBranch: "bold accent",
		gitStatus: "warning",
		contextNormal: "accent",
		contextWarning: "warning",
		contextError: "error",
		tokens: "muted",
		cost: "accent",
		separator: "dim",
		runtimePrefix: "accent",
		extensionStatus: "muted",
		sessionDuration: "warning",
		packageVersion: "accent",
		gitCommit: "success",
		gitMetricsAdded: "success",
		gitMetricsDeleted: "error",
		username: "muted",
		time: "muted",
		os: "text",
		editorAccent: "bold accent",
		editorPrompt: "bold accent",
		editorBorder: "borderMuted",
		editorModel: "bold accent",
		editorProvider: "muted",
		editorThinking: "thinkingHigh",
